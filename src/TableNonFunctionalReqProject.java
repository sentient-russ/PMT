...
public class TableNonFunctionalReqProject extends JTable {
    public TableNonFunctionalReqProject(){
        getTableHeader().setDefaultRenderer(new TableProjectHeader());
        getTableHeader().setPreferredSize(new Dimension(0,25));
        setDefaultRenderer(Object.class, new TableProjectCell());
        setRowHeight(25);
    }
    private class TableProjectHeader extends DefaultTableCellRenderer{
    @Override
    ...
    private class TableProjectCell extends DefaultTableCellRenderer{
        @Override
        ...
        public void scrollBarUpdateProjectTable(JScrollPane scroll) {
