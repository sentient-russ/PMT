 ...
 * @author russe
 */
public class TableTeamMembers extends JTable {
    public TableTeamMembers(){
        getTableHeader().setDefaultRenderer(new TableTeamMembersHeader());
        getTableHeader().setPreferredSize(new Dimension(0,25));
        setDefaultRenderer(Object.class, new TableTeamMemberCell());
        setRowHeight(25);
    }
    private class TableTeamMembersHeader extends DefaultTableCellRenderer{
        @Override
    ...
    private class TableTeamMemberCell extends DefaultTableCellRenderer{
        @Override
