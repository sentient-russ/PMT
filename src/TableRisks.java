 ...
 * @author russe
 */
public class TableRisks extends JTable {
    public TableRisks(){
        getTableHeader().setDefaultRenderer(new TableRisksHeader());
        getTableHeader().setPreferredSize(new Dimension(0,25));
        setDefaultRenderer(Object.class, new TableRisksCell());
        setRowHeight(25);
    }
    private class TableRisksHeader extends DefaultTableCellRenderer{
        @Override
    ...
    private class TableRisksCell extends DefaultTableCellRenderer{
        @Override
