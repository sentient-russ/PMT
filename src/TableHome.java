...
public class TableHome extends JTable {
    public TableHome(){
        getTableHeader().setDefaultRenderer(new TableHomeHeader());
        getTableHeader().setPreferredSize(new Dimension(0,25));
        setDefaultRenderer(Object.class, new TableHomeCell());
        setRowHeight(25);
        }

    private class TableHomeHeader extends DefaultTableCellRenderer{
        @Override
    ...
    private class TableHomeCell extends DefaultTableCellRenderer{
        @Override
        ...
        public void scrollBarUpdateHomeTable(JScrollPane scroll) {
